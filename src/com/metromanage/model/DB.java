...
public class DB {
    ...
    public static void createTables() {
        ...
        */
        ...
        String createAdminTable = "CREATE TABLE Admin (adminID INT PRIMARY KEY IDENTITY(1,1), name VARCHAR(100), email VARCHAR(100) UNIQUE, passwordHash VARCHAR(255), status VARCHAR(50), registrationDate DATETIME)";
